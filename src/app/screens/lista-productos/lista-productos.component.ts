...
export class ListaProductosComponent implements OnInit {
  ...
  //       c.map(k => this.all_products.push(k))
  //       route.queryParamMap.subscribe(params => {
  //         this.ids = params.keys;
      
  //     });
  //     console.log(this.ids);
  //     // console.log(this.);
  //     console.log(this.all_products);
  //   this.aleatoryProducts = productService.getNAleatoryProducts(this.n_aleatory_products,this.aleatoryProducts,this.all_products,this.numero);
  //     console.log(this.aleatoryProducts);
